...
(function() {
  ...
  BackendApp = (function() {
    function BackendApp() {
      var app;
      app = angular.module('BackendApp', ['ApiFactory', 'SystemFactory', 'ui.bootstrap', 'ui.tinymce', 'localytics.directives', 'ListingService', 'NumberOnlyDirective', 'blockUI', 'PaginationDirective', 'FileUploaderDirective', 'UploadFactory', 'SweetAlertService', 'SystemFilter', 'KeyBindDirective', 'ngAnimate', 'ngTagsInput']);
      app.config([
