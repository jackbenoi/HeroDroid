...
/**
 * App\Http\Controllers\Backend\Resources\ParentCategory
 * 
 * __DESCRIPTION__
 *
...
class ParentCategory extends Controller
{
    ...
    * @access  public
    **/
    public function __construct(Request $request,ParentCategoryRepositoryEloquent $category)
    {
    ...
    **/
    public function store()
    {
        try {
            ...
            $dataInput = array_only($input,['title','description','user_id','is_enabled','seo_title','seo_descriptions','seo_keywords','icon']);
