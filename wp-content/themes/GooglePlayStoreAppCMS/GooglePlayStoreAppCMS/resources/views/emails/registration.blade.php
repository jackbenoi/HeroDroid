                            ...
                            <table width="640" cellpadding="0" cellspacing="0" border="0" class="container">
                                ...
                                <tr>
                                    <td width="300" class="mobile" align="left" style="font-family: Arial, sans-serif; font-size:12px; line-height:18px;" st-content="preheader">
                                        Account Activation - {{ $configuration['site_title'] }}
                                    </td>
                                ...
                                <table width="640" cellpadding="0" cellspacing="0" align="center" border="0" class="container">
                                    ...
                                    <tr>
                                        <td align="left" style="font-family:Verdana, Arial, sans serif; font-size: 14px; color: #4d4d4d; line-height:18px; padding:0 20px;" st-content="title+text">
                                            ...
                                            <br>
                                            Thank you for registering to <strong>{{ $configuration['cms_name'] }}</strong>.<br/><br/>

                                            Please activate your account from this link 
                                            <a href="{{ $data['activation_link'] }}">Click Here to activate</a>
                    ...
                    <tr>
                        <td align="center">
                            ...
                            <table width="640" cellpadding="0" cellspacing="0" border="0" class="container">
                                ...
                                <tr>
                                    <td width="300" class="mobile" style="font-family:arial; font-size:12px; line-height:18px; color:#FFFFFF; padding-left:20px;" st-content="footer">
                                        &copy; 2017 All Rights Reserved - {{ $configuration['site_title'] }}
                                    </td>
